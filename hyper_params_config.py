...
parser.add_argument('inp_phon_type', type=str, choices=['g','p','f'], help="Phonological representation of the input", nargs='?', default='f')
parser.add_argument('out_phon_type', type=str, choices=['g','p','f'], help="Phonological representation of the output", nargs='?', default='p')
parser.add_argument('analogy_type', type=str, choices=['src2', 'src1_cross1', 'src1_cross2', 'None'], help='The analogies type to be applied', nargs='?', default='src1_cross1')
